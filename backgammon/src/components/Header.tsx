...
export function Header({ showClose, onClose, theme, onThemeToggle, onHelp, statusText, statusClass }: Props) {
  return (
    <header className="game-header">
      <div className="game-header__left">
        {showClose && (
          <button className="icon-btn" onClick={onClose} aria-label="Back to menu">
