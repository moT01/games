...
- When writing user facing code, never use characters that make is seem like AI wrote it. Like arrows or the em-dash.
- Always be explicit when writing anything, never vague. For instance, don't use "wait for user approval", use "approved when the user responds with 'approved'"
